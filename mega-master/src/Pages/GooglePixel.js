...
import googlePixel from "../Db/googlePixel"
    ...
    render() {
        return (
            <Breadcrumb>
                ...
                Все мобильные телефоны / Все телефоны Google Pixel
                </Breadcrumb.Item>
            </Breadcrumb>
        );
    }
    ...
    render() {
        return(
            <div className="content--text">
                <h1>Выберите свою модель Pixel</h1>
...
class GooglePixel extends React.Component {
    render() {
        return (
            <Container>
                <Row>
