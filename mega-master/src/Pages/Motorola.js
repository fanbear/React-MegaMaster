...
import motorola from "../Db/motorola.js";
    ...
    render() {
        return (
            <Breadcrumb>
                ...
                Все мобильные телефоны / Все телефоны Motorola
                </Breadcrumb.Item>
            </Breadcrumb>
        );
    }
    ...
    render() {
        return(
            <div className="content--text">
                <h1>Выберите свою модель Motorola</h1>
...
class Motorola extends React.Component {
    render() {
        return (
            <Container>
                <Row>
